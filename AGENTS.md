...
> This mirrors `CLAUDE.md` in the same folder. Kept as a separate file
> because some coding tools/harnesses (Cursor, Windsurf, etc.) look for
> `AGENTS.md` specifically rather than `CLAUDE.md`. If you update one,
> update the other.
